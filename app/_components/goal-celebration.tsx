...
/** Full-screen one-time celebration when a wealth-form goal is first hit. */
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-6">
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-label={`${formLabel} goal reached`}
        className={cn(
      ...
      >
        ...
        <p className="text-xs font-medium text-muted-foreground uppercase tracking-widest mb-1.5">
          {formLabel} goal reached
        </p>
        <p className="text-xl font-semibold leading-snug mb-2">
          You hit {targetLabel}!
        </p>
        <p className="text-sm text-muted-foreground leading-relaxed mb-6">
          Time to set the next goal for {formLabel} and keep going.
        </p>
        <button
          onClick={handleClose}
